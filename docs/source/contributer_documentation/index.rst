...
<https://github.com/MichaelSasser/devhelpers/issues/new/choose>`_ using
...
Please check the
`discussions <https://github.com/MichaelSasser/devhelpers/discussions>`_ first.
...
.. note:: Before you start make sure you hand in an `issue
          <https://github.com/MichaelSasser/devhelpers/issues/new/choose>`_.
...
5. Create a new branch from the
   `develop branch <https://github.com/MichaelSasser/devhelpers>`_.
...
.. note:: You often can use one if the :ref:`Tools` as template for a new
          feature.
